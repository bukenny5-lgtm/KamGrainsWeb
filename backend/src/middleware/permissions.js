export const ACTION_ROLES = {
  ...
  VIEW_TAX_CONFIGURATION: ["ADMIN", "MANAGER", "FINANCE", "AUDITOR"],
  MANAGE_TAX_CONFIGURATION: ["ADMIN", "MANAGER"],
  VIEW_PAYMENT_CHANNELS: ["ADMIN", "MANAGER", "FINANCE", "SALES", "AUDITOR", "VIEWER"],
  MANAGE_PAYMENT_CHANNELS: ["ADMIN", "MANAGER"],
  CONFIRM_MANUAL_PAYMENT: ["ADMIN", "MANAGER", "FINANCE", "SALES"],
  VIEW_PAYMENT_REFERENCES: ["ADMIN", "MANAGER", "FINANCE", "SALES", "AUDITOR"],
  VIEW_EFRIS_CONFIGURATION: ["ADMIN", "MANAGER", "FINANCE", "AUDITOR"],
  MANAGE_EFRIS_CONFIGURATION: ["ADMIN", "MANAGER"],
  VIEW_EFRIS_DOCUMENTS: ["ADMIN", "MANAGER", "FINANCE", "AUDITOR"],
  RETRY_EFRIS_DOCUMENT: ["ADMIN", "MANAGER", "FINANCE"],
  VIEW_EFRIS_ERRORS: ["ADMIN", "MANAGER", "FINANCE", "AUDITOR"],
  MANAGE_EFRIS_MAPPINGS: ["ADMIN", "MANAGER"],
  VIEW_VAT_REPORTS: ["ADMIN", "MANAGER", "FINANCE", "AUDITOR", "VIEWER"],
  VIEW_LOCATIONS: ["ADMIN", "MANAGER", "PURCHASING", "INVENTORY", "SALES", "FINANCE", "AUDITOR", "VIEWER"],
  VIEW_ALL_LOCATIONS: ["ADMIN", "MANAGER", "AUDITOR", "HEAD_OFFICE"],
  VIEW_ALL_BRANCHES: ["HEAD_OFFICE"],
  // Read-only stock visibility never grants branch transaction authority.
  VIEW_ALL_BRANCH_STOCK: ["ADMIN", "MANAGER", "AUDITOR", "HEAD_OFFICE", "STOCK_VISIBILITY"],
  EDIT_LOCATIONS: ["ADMIN", "MANAGER"],
  TRANSFER_STOCK: ["ADMIN", "MANAGER", "INVENTORY"],
  RECEIVE_STOCK_TRANSFER: ["ADMIN", "MANAGER", "INVENTORY"],
  CREATE_STOCK_REQUEST: ["ADMIN", "MANAGER", "INVENTORY", "PURCHASING", "HEAD_OFFICE"],
  APPROVE_STOCK_REQUEST: ["ADMIN", "MANAGER", "PURCHASING"],
  VIEW_ALL_STOCK_REQUESTS: ["ADMIN", "MANAGER", "PURCHASING", "AUDITOR", "HEAD_OFFICE"],
  VIEW_TRANSFER_COST: ["ADMIN", "MANAGER", "FINANCE", "HEAD_OFFICE"],

  // Purchasing / GRN
  CREATE_PURCHASE_ORDER: ["ADMIN", "MANAGER", "PURCHASING"],
  CREATE_BRANCH_PO: ["ADMIN", "MANAGER", "PURCHASING"],
  APPROVE_BRANCH_PO: ["ADMIN", "MANAGER", "HEAD_OFFICE"],
